...
Чат «Спросить Claude»: обычные вопросы отвечает фразой-заглушкой; вопросы со словом «выручка»,
«деньги на счетах» или «остатки» — по-настоящему вызывают инструмент со сводом по деньгам (виден
только тем, у кого есть доступ к финансам). Спецвопросы для проверки ошибок: начните вопрос со слов
«фейк:429», «фейк:500», «фейк:refusal» или «фейк:maxtokens».
